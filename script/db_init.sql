...
CREATE TABLE Products (
  ...
  Tags NVARCHAR(400) NULL  -- ADDED THIS COLUMN
)
...
CREATE TABLE Orders (
  ...
  PaymentMethod NVARCHAR(30) NOT NULL, -- stripe_card
...
-- sample data with all 6 columns
INSERT INTO Products (Id, Name, ImageUrl, PriceCents, Category, Tags)
VALUES
